...
export function getStudents() {
  return axios.get('http://192.168.49.2:30984/students/')
    .then(response => response.data)
}

export function deleteStudent(studentId) {
  return axios.delete('http://192.168.49.2:30984/students/' + studentId + '/', {
   method: 'DELETE',
   headers: {
...
export function addStudent(student){
  return axios.post('http://192.168.49.2:30984/students/', {
    studentId:null,
